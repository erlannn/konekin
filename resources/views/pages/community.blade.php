...
<div class="text-center communitybrand  mt-5 mx-auto">
    <h1 class="h1ajah">"What communities can you join here?"</h1>
    <p class="pajah mx-auto">Discover different communities here! Find one you like, connect with people who share <br>
    your interests, and enjoy a vibrant community experience with us!.</p>
  </div>
<br><br><br>

<div class="text-center">
        <a href="/createcommunity" class="btncreate2 badge text-wrap text-center ms-3 me-3"><button class="btn p-2" >Create Community</button></a>
</div>
